...
import TopBrandsCollections from './TopBrandsCollections'
...
const DeliveryContent = [
    ...
    },
    {
        id: 5,
        name: "Cuisines",
        icon: <i className="sc-rbbb40-1 iFnyeo" size="18" color="#9C9C9C"><svg xmlns="http://www.w3.org/2000/svg" fill="#9C9C9C" width="18" height="18" viewBox="0 0 20 20" aria-labelledby="icon-svg-title- icon-svg-desc-" role="img" className="sc-rbbb40-0 iwHbVQ"><title>chevron-down</title><path d="M4.48 7.38c0.28-0.28 0.76-0.28 1.060 0l4.46 4.48 4.48-4.48c0.28-0.28 0.76-0.28 1.060 0s0.28 0.78 0 1.060l-5 5c-0.3 0.3-0.78 0.3-1.060 0l-5-5c-0.3-0.28-0.3-0.76 0-1.060z"></path></svg></i>
    },
    {
        id: 6,
        name: "More filters",
...
const exploreTitle = "Order food online in Ruby Hospital Area, Kolkata"


const Delivery = () => {
    return (
        <>
            <Filter content={DeliveryContent} />
            <DeliveryCollections/>
            <TopBrandsCollections/>
            <ExploreSection list={restaurent} exploreTitle={exploreTitle}/>
        </>
    )
}
